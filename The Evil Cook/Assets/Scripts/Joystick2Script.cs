...
{
	public class Joystick2Script : MonoBehaviour, ISimpleInputDraggable
	{
		public enum MovementAxes { XandY, X, Y };

		public SimpleInput.AxisInput xAxis = new SimpleInput.AxisInput("Horizontal2");
		public SimpleInput.AxisInput yAxis = new SimpleInput.AxisInput("Vertical2");
